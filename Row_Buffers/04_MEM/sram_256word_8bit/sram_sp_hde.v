...
//       
//       Creation Date:  Mon Jan  8 22:09:36 2024
//       Version: 	r11p2
//
...
`endif
  ...
  reg NOT_TA6, NOT_TA5, NOT_TA4, NOT_TA3, NOT_TA2, NOT_TA1, NOT_TA0, NOT_TD7, NOT_TD6;
	...
	dump_file_desc = $fopen(filename_dump);
     if (CEN_ === 1'b1) begin
      ...
      row = mem[row_address];
        ...
        Q_int = {shifted_readLatch0[14], shifted_readLatch0[12], shifted_readLatch0[10],
...
`endif
 ...
 wire  CLK_;
  ...
  buf B43(D_[6], D[6]);
  buf B44(D_[7], D[7]);
  buf B45(EMA_[0], EMA[0]);
  buf B46(EMA_[1], EMA[1]);
  buf B47(EMA_[2], EMA[2]);
  buf B48(EMAW_[0], EMAW[0]);
  buf B49(EMAW_[1], EMAW[1]);
  buf B50(EMAS_, EMAS);
  buf B51(TEN_, TEN);
  buf B52(BEN_, BEN);
  buf B53(TCEN_, TCEN);
