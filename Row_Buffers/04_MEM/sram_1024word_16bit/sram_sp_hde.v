...
//       
//       Creation Date:  Mon Jan  8 22:19:02 2024
//       Version: 	r11p2
//
...
`endif
  ...
  reg NOT_EMA1, NOT_EMA0, NOT_EMAW1, NOT_EMAW0, NOT_EMAS, NOT_TEN, NOT_TCEN, NOT_TWEN;
  reg NOT_TA9, NOT_TA8, NOT_TA7, NOT_TA6, NOT_TA5, NOT_TA4, NOT_TA3, NOT_TA2, NOT_TA1;
  reg NOT_TA0, NOT_TD15, NOT_TD14, NOT_TD13, NOT_TD12, NOT_TD11, NOT_TD10, NOT_TD9;
 ...
 wire  CLK_;
  ...
  assign `ARM_UD_DP AY_ = RET1N_ ? (TEN_ ? A_ : TA_) : {10{1'bx}};
...
`endif
 ...
 wire  CLK_;
  ...
  buf B20(DY[8], DY_[8]);
  buf B21(DY[9], DY_[9]);
  buf B22(DY[10], DY_[10]);
  buf B23(DY[11], DY_[11]);
  buf B24(DY[12], DY_[12]);
  buf B25(DY[13], DY_[13]);
  buf B26(DY[14], DY_[14]);
  buf B27(DY[15], DY_[15]);
  buf B28(Q[0], Q_[0]);
  buf B29(Q[1], Q_[1]);
  buf B30(Q[2], Q_[2]);
  buf B31(Q[3], Q_[3]);
  ...
  buf B71(D_[14], D[14]);
  buf B72(D_[15], D[15]);
  buf B73(EMA_[0], EMA[0]);
  buf B74(EMA_[1], EMA[1]);
  buf B75(EMA_[2], EMA[2]);
  buf B76(EMAW_[0], EMAW[0]);
  buf B77(EMAW_[1], EMAW[1]);
  buf B78(EMAS_, EMAS);
  buf B79(TEN_, TEN);
  buf B80(BEN_, BEN);
  buf B81(TCEN_, TCEN);
  ...
  buf B101(TD_[8], TD[8]);
  buf B102(TD_[9], TD[9]);
  buf B103(TD_[10], TD[10]);
  buf B104(TD_[11], TD[11]);
  buf B105(TD_[12], TD[12]);
  buf B106(TD_[13], TD[13]);
  buf B107(TD_[14], TD[14]);
  buf B108(TD_[15], TD[15]);
  buf B109(TQ_[0], TQ[0]);
  buf B110(TQ_[1], TQ[1]);
  buf B111(TQ_[2], TQ[2]);
  buf B112(TQ_[3], TQ[3]);
  ...
  buf B117(TQ_[8], TQ[8]);
  buf B118(TQ_[9], TQ[9]);
  buf B119(TQ_[10], TQ[10]);
  buf B120(TQ_[11], TQ[11]);
  buf B121(TQ_[12], TQ[12]);
  buf B122(TQ_[13], TQ[13]);
  buf B123(TQ_[14], TQ[14]);
  buf B124(TQ_[15], TQ[15]);
  buf B125(RET1N_, RET1N);
  buf B126(STOV_, STOV);

  assign CENY_ = RET1N_ ? (TEN_ ? CEN_ : TCEN_) : 1'bx;
  assign WENY_ = RET1N_ ? (TEN_ ? WEN_ : TWEN_) : 1'bx;
  assign AY_ = RET1N_ ? (TEN_ ? A_ : TA_) : {10{1'bx}};
